<div class="docs-hero">
  <h1>Arcee</h1>
  <p class="docs-hero-lead">Modern .NET SDK for Arcee AI APIs, generated with AutoSDK from a hand-maintained OpenAPI definition.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/Arcee/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/Arcee"></a>
    <a href="https://github.com/tryAGI/Arcee/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/Arcee/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/Arcee/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/Arcee"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from a hand-maintained OpenAPI file based on <a href="https://docs.arcee.ai/api-reference/chat-completion">Arcee AI API docs</a>.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
using var client = new ArceeClient(apiKey);
```
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/Arcee/issues">tryAGI/Arcee</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/Arcee/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
